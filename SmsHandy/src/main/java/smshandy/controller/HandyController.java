...
//    private Label deletePhoneBtn;
	...
	public void initialize() {
		...
		/**
		 * Initializes the controller class and initialize the handy table with the two
		 * columns.
		 */
	...
	/**
	 * Shows the details of a SmsHandy. If, handy is null, the details are cleared.
	 * 
	...
	/**
	 * Return the art of the smshandy.
	 * 
	 * @param smsHandy the to ckecked smshandy
	 * @return Prepaid Plan, when the smshandy is a prepaid handy, otherwise Tariff
	 *         Plan
	 */
	...
	@FXML
	/**
	 * Change the provider of a SmsHandy.
	 */
